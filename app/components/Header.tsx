  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center gap-4">
              <CTAButton href="/free-estimate" variant="primary" trackingLabel="header">
                Schedule Estimate
              </CTAButton>
            </div>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-[var(--border)] p-3 flex gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
        ...
        <CTAButton href="/free-estimate" variant="primary" className="flex-1" trackingLabel="mobile-sticky">
          Schedule Estimate
        </CTAButton>
      </div>
    </>
